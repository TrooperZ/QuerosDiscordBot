...
class Music(commands.Cog):
     ...
     async def _join(self, ctx: commands.Context):
          """Joins a voice channel that you are in."""
          ...
          try:
                    ...
                    raise discord.DiscordException('Invalid Voice Channel.')
     ...
     async def _summon(self, ctx: commands.Context, *, channel: discord.VoiceChannel=None):
          """Summons and moves the bot to a voice channel. If no channel was specified, it joins your channel. (Admin Only)"""
          cmds = configcol.find({"$and": [{"guild": ctx.guild.id}, {"cfg_type": 'cmdsoff'}]})
          cmdsList = ['0']
          for i in cmds:
                    cmdOff = i['commands']
